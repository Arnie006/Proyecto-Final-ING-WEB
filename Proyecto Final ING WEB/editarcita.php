...
if (isset($_POST['ingresar_cita'])){
    ...
    $cita_check_query = "SELECT fecha FROM prueba_citas WHERE fecha='$date' and id_medico='$doctor'";
    ...
    if ($cita['fecha'] === $date){
        ...
        $addcita_sql = "UPDATE prueba_citas set fecha = $date where id_citas =".$modcita; 
